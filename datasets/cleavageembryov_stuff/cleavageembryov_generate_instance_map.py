...
parser.add_argument('--annotation_file', type=str, default="../CleavageEmbryov1.1/CleavageEmbryov1.1/annotations/instances_train.json",
                    help="Path to the annocation file. It can be downloaded at https://www.kaggle.com/datasets/austin012/cleavageembryo-dataset?resource=download. Should be either instances_train.json or instances_val.json")
