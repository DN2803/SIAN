...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='label2cell', help='name of the experiment. It decides where to store samples and models')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='sian', help='selects model to use for netG (pix2pixhd | sian)')
